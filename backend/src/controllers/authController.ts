...
export const signup = async (req: Request, res: Response) => {
  try {
    ...
    res.cookie('accessToken', accessToken, { httpOnly: true, sameSite:true,secure:true,maxAge: 3 * 60 * 60 * 1000 });
    res.cookie('refreshToken', refreshToken, { httpOnly: true,sameSite:true,secure:true, maxAge: 7 * 24 * 60 * 60 * 1000 });
